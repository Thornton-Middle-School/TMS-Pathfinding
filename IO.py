...
# for place in root.findall(prefix + "Placemark"):
#     name = place.find(prefix + "name").text
#     coordinates[name][0] = (coordinates[name][0] - left) * 200000
#     coordinates[name][1] = (coordinates[name][1] - bottom) * 200000
...
make_equal("6.2", "7.2", "8.2", "9.2", "A101.1", "A106.1", "A201.1", "A205.1", "B101.1", "B201.1", "B106.2", "B205.2", latitude=False)
make_equal("12.1", "13.1", "C101.1", "C107.1", "C201.1", "C205.1", "D105.2", "D205.2", latitude=False)
make_equal("12.2", "13.2", "14.2", "15.2", "C101.2", "C107.2", "C201.2", "C205.2", "D105.1", "D205.1", "D106.2", "D206.2", latitude=False)
...
make_equal("16A.2", "17.1", "18.1", "19.1", "26.2", longitude=False, goto=True)
...
for place in root.findall(prefix + "Placemark"):
    ...
    # print(name, coordinates[name], old[name])
